...
const StatsSection: React.FC = () => (
    <section className="py-16 md:py-24 bg-brand-orange text-[#f4f1e6] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12 text-center">
            {STATS.map((stat, i) => (
                <div key={i} className="reveal" style={{ animationDelay: `${i * 100}ms` }}>
                    <p className="font-serif text-3xl sm:text-5xl md:text-7xl mb-2 text-[#2d3282]">{stat.value}</p>
        ...
        <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
                <div className="lg:w-1/2">
                    <p className="text-[#2d3282] font-bold text-[10px] uppercase tracking-[0.3em] mb-4">Who We Are</p>
                    <h2 className="text-[#f39223] font-serif text-4xl md:text-6xl mb-8">Decades of Excellence in Logistics</h2>
                    ...
                    <Link to="/about" className="inline-block px-10 py-4 bg-[#345e37] text-white text-[10px] font-bold uppercase tracking-widest hover:bg-[#2d3282] transition-colors">
                        Discover Our Story
                    </Link>
                </div>
                <div className="lg:w-1/2 grid grid-cols-2 gap-4">
                    <div className="aspect-square bg-[#f4f1e6] p-8 flex flex-col justify-center border border-gray-100">
                        <p className="text-4xl font-serif text-[#f39223] mb-2">1700+</p>
                    ...
                    <div className="aspect-square bg-white p-8 flex flex-col justify-center border border-gray-100 shadow-sm">
                        <p className="text-4xl font-serif text-[#2d3282] mb-2">24/7</p>
    ...
    <section className="py-16 md:py-32 bg-[#f4f1e6] px-6">
        <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 md:mb-24 gap-8">
                <div>
                    <p className="text-[#2d3282] font-bold text-[10px] uppercase tracking-[0.3em] mb-4">Our Services</p>
                    <h2 className="text-[#f39223] font-serif text-4xl md:text-6xl">Core Solutions</h2>
                </div>
                <Link to="/services" className="text-[#2d3282] font-bold text-[10px] uppercase tracking-widest border-b-2 border-[#2d3282] pb-1 hover:text-[#f39223] hover:border-[#f39223] transition-all">
                    View All Services
                </Link>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {SERVICES.slice(0, 3).map((service) => (
                    <div key={service.id} className="bg-white p-10 border border-gray-100 hover:shadow-xl transition-all group">
                        <h4 className="text-[#f39223] font-serif text-2xl mb-4 group-hover:text-[#2d3282] transition-colors">{service.title}</h4>
        ...
        <section id="faq" className="py-16 md:py-32 px-6 md:px-12 bg-[#f4f1e6]">
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24">
                    <div>
                        <p className="text-[#2d3282] font-bold text-[10px] uppercase tracking-[0.3em] mb-4">Support</p>
                        <h2 className="text-[#f39223] font-serif text-3xl sm:text-5xl md:text-7xl leading-[1.1] mb-6 md:mb-8">Questions <br />You May Have</h2>
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, i) => (
                            <div
                                ...
                                className={`transition-all duration-300 overflow-hidden ${openIndex === i ? 'bg-[#345e37] text-white p-8' : 'bg-white text-[#345e37] p-6'} cursor-pointer hover:shadow-md border border-gray-100`}
                            >
...
const LeadForm: React.FC = () => (
    <section className="py-16 md:py-32 px-6 bg-brand-orange relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
            <div className="text-center mb-10 md:mb-16">
                ...
                <p className="text-[#2d3282] text-xs md:text-sm font-bold tracking-[0.4em] uppercase">Get a Quote for Your Next Shipment</p>
            </div>

            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-6 md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <input type="text" placeholder="YOUR NAME" className="bg-transparent border-b border-white/20 p-4 text-white placeholder:text-white/30 text-xs font-bold tracking-widest outline-none focus:border-[#2d3282] transition-colors" />
                    <input type="text" placeholder="PHONE NUMBER" className="bg-transparent border-b border-white/20 p-4 text-white placeholder:text-white/30 text-xs font-bold tracking-widest outline-none focus:border-[#2d3282] transition-colors" />
                    <input type="email" placeholder="EMAIL (OPTIONAL)" className="bg-transparent border-b border-white/20 p-4 text-white placeholder:text-white/30 text-xs font-bold tracking-widest outline-none focus:border-[#2d3282] transition-colors" />
                </div>

                <div className="md:col-span-2 flex flex-col md:flex-row items-center justify-between gap-8 pt-8">
                    <div className="flex items-center gap-3">
                        <input type="checkbox" id="terms" className="w-4 h-4 rounded-none border-white/20 bg-transparent text-[#2d3282]" />
                    ...
                    <button className="w-full md:w-auto px-16 py-5 bg-[#2d3282] text-white font-bold text-xs tracking-[0.3em] uppercase hover:bg-white hover:text-[#2d3282] transition-all">
                        Get Pricing
                    </button>
                </div>
            </form>

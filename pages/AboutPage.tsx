                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1">
                            <h2 className="text-[#f39223] font-serif text-4xl md:text-6xl mb-8">Our Journey</h2>
                        ...
                        <div className="order-1 lg:order-2 relative aspect-square md:aspect-video lg:aspect-square overflow-hidden rounded-2xl shadow-2xl">
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-tr from-[#f39223]/40 to-transparent"></div>
                        </div>
                    </div>
                </div>
            </section>

        ...
        <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-24 items-center">
                <div className="lg:w-1/2">
                    <p className="text-[#2d3282] font-bold text-[10px] uppercase tracking-[0.3em] mb-4">Our Fleet</p>
                    <h2 className="text-[#f39223] font-serif text-3xl sm:text-5xl md:text-7xl mb-6 md:mb-8 leading-tight">Clean & Reliable <br />Trucks</h2>
                    ...
                    <div className="space-y-3 md:space-y-6">
                        {FLEET_DETAILS.map((fleet, i) => (
                            <div key={i} className="flex items-center gap-4 md:gap-6 p-4 md:p-6 bg-white border border-gray-100 hover:border-[#2d3282] transition-all shadow-sm">
                                <span className="text-2xl md:text-4xl">{fleet.icon}</span>
                                <div>
                                    <h4 className="font-bold text-[#345e37] text-sm uppercase tracking-widest">{fleet.name}</h4>
        ...
        <div className="pt-20">
            ...
            <section className="py-16 md:py-32 px-6 md:px-12 bg-white">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-[#f39223] font-serif text-4xl md:text-6xl mb-8">Strategic Local Presence</h2>
                    ...
                    <div className="inline-block px-12 py-6 bg-[#345e37] text-white rounded-full">

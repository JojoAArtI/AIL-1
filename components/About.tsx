      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-24 items-start mb-16 md:mb-24">
          <div className="lg:w-1/3 w-full">
            ...
            <h2 className="text-[#2d4133] font-serif text-3xl sm:text-5xl md:text-7xl leading-[1.1] mb-6 md:mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 border-t border-gray-200 pt-12 md:pt-24">
          <div>
            <h4 className="text-[#c5a47e] font-bold text-[10px] uppercase tracking-[0.3em] mb-6">Our Vision</h4>
            <p className="text-[#2d4133] font-serif text-2xl md:text-3xl mb-4 italic leading-tight">Giving businesses the best shipping help in India.</p>
          ...
          <div>
            ...
            <p className="text-[#2d4133] font-serif text-2xl md:text-3xl mb-4 italic leading-tight">Save money and grow your business with us.</p>
          ...
          <div>
            ...
            <p className="text-[#2d4133] font-serif text-2xl md:text-3xl mb-4 italic leading-tight">"We make shipping big stuff look easy."</p>

...
const StatsSection: React.FC = () => (
  <section className="py-24 bg-brand-green text-[#f4f1e6] relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
      {STATS.map((stat, i) => (
        <div key={i} className="reveal" style={{ animationDelay: `${i * 100}ms` }}>
          <p className="font-serif text-5xl md:text-7xl mb-2 text-[#c5a47e]">{stat.value}</p>
  ...
  <section className="py-24 md:py-32 bg-white px-6">
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-20">
        ...
        <h2 className="text-[#2d4133] font-serif text-5xl md:text-7xl">How We Work</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        {PROCESS_STEPS.map((step, i) => (
          <div key={i} className="group relative">
            <span className="text-8xl font-serif text-[#2d4133]/5 absolute -top-8 -left-4 group-hover:text-[#c5a47e]/10 transition-colors">{step.step}</span>
...
const FleetShowcase: React.FC = () => (
  <section className="py-24 md:py-32 bg-[#f4f1e6] px-6">
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
        <div className="lg:w-1/2">
          <p className="text-[#c5a47e] font-bold text-[10px] uppercase tracking-[0.3em] mb-4">Our Fleet</p>
          <h2 className="text-[#2d4133] font-serif text-5xl md:text-7xl mb-8 leading-tight">Clean & Reliable <br />Trucks</h2>
          ...
          <div className="space-y-6">
            {FLEET_DETAILS.map((fleet, i) => (
              <div key={i} className="flex items-center gap-6 p-6 bg-white border border-gray-100 hover:border-[#c5a47e] transition-all shadow-sm">
...
const FAQ: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-24 md:py-32 px-6 md:px-12 bg-[#f4f1e6]">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          <div>
            <p className="text-[#c5a47e] font-bold text-[10px] uppercase tracking-[0.3em] mb-4">Support</p>
            <h2 className="text-[#2d4133] font-serif text-5xl md:text-7xl leading-[1.1] mb-8">Questions <br />You May Have</h2>
...
const LeadForm: React.FC = () => (
  <section className="py-32 px-6 bg-brand-green relative overflow-hidden">
    <div className="absolute inset-0 opacity-10 striped-bg pointer-events-none"></div>
    <div className="max-w-4xl mx-auto relative z-10">
      <div className="text-center mb-16">
        <h3 className="font-serif text-5xl md:text-7xl text-[#f4f1e6] mb-6">Start Moving <br className="md:hidden" />With Us Today</h3>
